...
public:
    Student(const std::string& surname, 
        ...
        const std::string& recordBook): id(0), 
        surname(surname), name(name), patronymic(patronymic),
        institute(institute), department(department), course(course),
        ...
        Student(int id,
            ...
            int course,
            const std::string& group,
            const std::string& recordBook) : id(id), 
            surname(surname), name(name), patronymic(patronymic),
            institute(institute), department(department), course(course),
            group(group), recordBook(recordBook) {}
